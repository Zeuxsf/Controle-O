...
# Resto dos controles
/usr/bin/v4l2-ctl -d /dev/video0 --set-ctrl=brightness=40
/usr/bin/v4l2-ctl -d /dev/video0 --set-ctrl=contrast=700
/usr/bin/v4l2-ctl -d /dev/video0 --set-ctrl=saturation=500
/usr/bin/v4l2-ctl -d /dev/video0 --set-ctrl=gamma=30
...
/usr/bin/v4l2-ctl -d /dev/video0 --set-ctrl=sharpness=256
